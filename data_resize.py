...
origin_path = 'F:/360Downloads/PavementData2107/'

target_path = 'F:/360Downloads/PavementDataResize2107/'
        ...
        for file in files:
            if os.path.splitext(file)[-1] in image_type:
                try:
                    ...
                    continue
                img.save(os.path.join(target_dir_path, file), "JPEG", quality=100)
